...
gnu_java_nio_charset_ISO_8859_1_Encoder__new__L7qsf6( java_nio_charset_Charset
 cs )
{
 return gnu_java_nio_charset_ISO_8859_1_Encoder__this__L7qsf6(
  (gnu_java_nio_charset_ISO_8859_1_Encoder)jcgo_newObject((jvtable)&gnu_java_nio_charset_ISO_8859_1_Encoder_methods),
  cs);
}
...
JCGO_NOSEP_DATA CONST struct gnu_java_nio_charset_ISO_8859_1_Encoder_methods_s
 gnu_java_nio_charset_ISO_8859_1_Encoder_methods=
{
 JCGO_CLASSREF_OF(gnu_java_nio_charset_ISO_8859_1_Encoder__class),
 JCGO_GCJDESCR_INIT(gnu_java_nio_charset_ISO_8859_1_Encoder_s, unmappableCharacterAction)
 OBJT_gnu_java_nio_charset_ISO_8859_1_Encoder,
...
JCGO_NOSEP_DATA JCGO_NOTHR_CONST struct gnu_java_nio_charset_ISO_8859_1_Encoder_class_s
 gnu_java_nio_charset_ISO_8859_1_Encoder__class JCGO_THRD_ATTRNONGC=
{
 {
  &java_lang_Class_methods,
  JCGO_MON_INIT
  JCGO_OBJREF_OF(*(java_lang_Object)&gnu_java_nio_charset_ISO_8859_1_Encoder_methods),
  JCGO_STRREF_OF(jcgo_string1_Encoder),
...
JCGO_NOSEP_DATA CONST jcgo_arrtype627_Mdclnt jcgo_array2_Encoder=
{
 ...
 39,
 {
  (jbyte)(jchar)103/*'g'*/, (jbyte)(jchar)110/*'n'*/, (jbyte)(jchar)117/*'u'*/,
   ...
   (jbyte)(jchar)49/*'1'*/, (jbyte)(jchar)36/*'$'*/, (jbyte)(jchar)69/*'E'*/,
   (jbyte)(jchar)110/*'n'*/, (jbyte)(jchar)99/*'c'*/, (jbyte)(jchar)111/*'o'*/,
   (jbyte)(jchar)100/*'d'*/, (jbyte)(jchar)101/*'e'*/, (jbyte)(jchar)114/*'r'*/
 }
};

JCGO_NOSEP_DATA JCGO_NOTHR_CONST struct java_lang_String_s jcgo_string1_Encoder
 JCGO_THRD_ATTRNONGC=
{
 &java_lang_String_methods,
 JCGO_MON_INIT
 (java_lang_Object)JCGO_OBJREF_OF(jcgo_array2_Encoder),
 0, 39, (jint)0x5939190L
};
