...
struct gnu_java_nio_charset_ByteCharset_Decoder_methods_s
{
 ...
 JCGO_CLINIT_DEFN
 gnu_java_nio_charset_ByteCharset_Decoder (CFASTCALL *jcgo_thisRtn)(
  gnu_java_nio_charset_ByteCharset_Decoder This );
...
struct gnu_java_nio_charset_ByteCharset_Decoder_class_s
{
 struct java_lang_Class_s jcgo_class;
};

JCGO_SEP_EXTERN CONST struct gnu_java_nio_charset_ByteCharset_Decoder_methods_s
 gnu_java_nio_charset_ByteCharset_Decoder_methods;
JCGO_SEP_EXTERN JCGO_NOTHR_CONST struct gnu_java_nio_charset_ByteCharset_Decoder_class_s
 gnu_java_nio_charset_ByteCharset_Decoder__class;

struct gnu_java_nio_charset_ByteCharset_Decoder_s
{
 CONST struct gnu_java_nio_charset_ByteCharset_Decoder_methods_s *JCGO_IMMFLD_CONST
  jcgo_methods;
 JCGO_MON_DEFN
...
JCGO_SEP_EXTERN JCGO_NOTHR_CONST struct java_lang_String_s jcgo_string1_Dcdr01;
