...
struct java_lang_ClassNotFoundException_methods_s
{
 ...
 JCGO_CLINIT_DEFN
 java_lang_ClassNotFoundException (CFASTCALL *jcgo_thisRtn)( java_lang_ClassNotFoundException
  This );
 ...
 java_lang_Throwable (CFASTCALL *getCause__)( java_lang_ClassNotFoundException
  This );
};

struct java_lang_ClassNotFoundException_class_s
{
 struct java_lang_Class_s jcgo_class;
};

JCGO_SEP_EXTERN CONST struct java_lang_ClassNotFoundException_methods_s
 java_lang_ClassNotFoundException_methods;
JCGO_SEP_EXTERN JCGO_NOTHR_CONST struct java_lang_ClassNotFoundException_class_s
 java_lang_ClassNotFoundException__class;

struct java_lang_ClassNotFoundException_s
{
 CONST struct java_lang_ClassNotFoundException_methods_s *JCGO_IMMFLD_CONST
  jcgo_methods;
 JCGO_MON_DEFN
...
JCGO_SEP_EXTERN CONST jcgo_arrtype98_GmCnnctn jcgo_array2_ClNtFnEx;

JCGO_SEP_EXTERN JCGO_NOTHR_CONST struct java_lang_String_s jcgo_string1_ClNtFnEx;
