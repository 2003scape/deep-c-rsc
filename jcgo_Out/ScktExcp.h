...
struct java_net_SocketException_methods_s
{
 ...
 JCGO_CLINIT_DEFN
 java_net_SocketException (CFASTCALL *jcgo_thisRtn)( java_net_SocketException
  This );
...
struct java_net_SocketException_class_s
{
 struct java_lang_Class_s jcgo_class;
};

JCGO_SEP_EXTERN CONST struct java_net_SocketException_methods_s java_net_SocketException_methods;
JCGO_SEP_EXTERN JCGO_NOTHR_CONST struct java_net_SocketException_class_s
 java_net_SocketException__class;

struct java_net_SocketException_s
{
 CONST struct java_net_SocketException_methods_s *JCGO_IMMFLD_CONST
  jcgo_methods;
 JCGO_MON_DEFN
...
JCGO_SEP_EXTERN CONST jcgo_arrtype94_GmCnnctn jcgo_array2_ScktExcp;

JCGO_SEP_EXTERN JCGO_NOTHR_CONST struct java_lang_String_s jcgo_string1_ScktExcp;
