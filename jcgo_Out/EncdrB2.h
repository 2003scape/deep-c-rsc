...
struct gnu_java_nio_charset_US_ASCII_Encoder_methods_s
{
 ...
 JCGO_CLINIT_DEFN
 gnu_java_nio_charset_US_ASCII_Encoder (CFASTCALL *jcgo_thisRtn)( gnu_java_nio_charset_US_ASCII_Encoder
  This );
 ...
 java_nio_charset_CoderResult (CFASTCALL *encodeLoop__L3367bL9oaia)(
  gnu_java_nio_charset_US_ASCII_Encoder This, java_nio_CharBuffer in,
  java_nio_ByteBuffer out );
 void (CFASTCALL *implReset__)( java_nio_charset_CharsetEncoder This
  );
};

struct gnu_java_nio_charset_US_ASCII_Encoder_class_s
{
 struct java_lang_Class_s jcgo_class;
};

JCGO_SEP_EXTERN CONST struct gnu_java_nio_charset_US_ASCII_Encoder_methods_s
 gnu_java_nio_charset_US_ASCII_Encoder_methods;
JCGO_SEP_EXTERN JCGO_NOTHR_CONST struct gnu_java_nio_charset_US_ASCII_Encoder_class_s
 gnu_java_nio_charset_US_ASCII_Encoder__class;

struct gnu_java_nio_charset_US_ASCII_Encoder_s
{
 CONST struct gnu_java_nio_charset_US_ASCII_Encoder_methods_s *JCGO_IMMFLD_CONST
  jcgo_methods;
 JCGO_MON_DEFN
...
JCGO_SEP_EXTERN CONST jcgo_arrtype92_GmCnnctn jcgo_array2_EncdrB2;

JCGO_SEP_EXTERN JCGO_NOTHR_CONST struct java_lang_String_s jcgo_string1_EncdrB2;
