...
struct java_io_IOException_methods_s
{
 ...
 JCGO_CLINIT_DEFN
 java_io_IOException (CFASTCALL *jcgo_thisRtn)( java_io_IOException
  This );
...
struct java_io_IOException_class_s
{
 struct java_lang_Class_s jcgo_class;
};

JCGO_SEP_EXTERN CONST struct java_io_IOException_methods_s java_io_IOException_methods;
JCGO_SEP_EXTERN JCGO_NOTHR_CONST struct java_io_IOException_class_s
 java_io_IOException__class;

struct java_io_IOException_s
{
 CONST struct java_io_IOException_methods_s *JCGO_IMMFLD_CONST jcgo_methods;
 JCGO_MON_DEFN
...
JCGO_SEP_EXTERN CONST jcgo_arrtype42_GameShll jcgo_array2_IOExcptn;

JCGO_SEP_EXTERN JCGO_NOTHR_CONST struct java_lang_String_s jcgo_string1_IOExcptn;
