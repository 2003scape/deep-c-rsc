...
#ifdef CHKALL_java_io_FileNotFoundException
#include "jcgobchk.h"
#endif
...
{
 return java_io_FileNotFoundException__this__Ls(
  (java_io_FileNotFoundException)jcgo_newObject((jvtable)&java_io_FileNotFoundException_methods),
  message);
}

JCGO_NOSEP_DATA CONST struct java_io_FileNotFoundException_methods_s
 java_io_FileNotFoundException_methods=
{
 JCGO_CLASSREF_OF(java_io_FileNotFoundException__class),
 JCGO_GCJDESCR_ZEROINIT
 OBJT_java_io_FileNotFoundException,
 (JCGO_OBJSIZE_T)sizeof(struct java_io_FileNotFoundException_s),
 NULL,
 JCGO_CLINIT_INIT(0)
 java_io_FileNotFoundException__this__,
...
JCGO_NOSEP_DATA JCGO_NOTHR_CONST struct java_io_FileNotFoundException_class_s
 java_io_FileNotFoundException__class JCGO_THRD_ATTRNONGC=
{
 {
  &java_lang_Class_methods,
  JCGO_MON_INIT
  JCGO_OBJREF_OF(*(java_lang_Object)&java_io_FileNotFoundException_methods),
  JCGO_STRREF_OF(jcgo_string1_FlNtFnEx),
...
JCGO_NOSEP_DATA CONST jcgo_arrtype86_GmCnnctn jcgo_array2_FlNtFnEx=
{
...
JCGO_NOSEP_DATA JCGO_NOTHR_CONST struct java_lang_String_s jcgo_string1_FlNtFnEx
 JCGO_THRD_ATTRNONGC=
{
 &java_lang_String_methods,
 JCGO_MON_INIT
 (java_lang_Object)JCGO_OBJREF_OF(jcgo_array2_FlNtFnEx),
 0, 29, (jint)0xb44601e8L
};
