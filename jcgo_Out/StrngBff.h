...
#define java_lang_StringBuffer__DEFAULT_CAPACITY (jint)16
...
struct java_lang_StringBuffer_methods_s
{
 ...
 JCGO_CLINIT_DEFN
 java_lang_StringBuffer (CFASTCALL *jcgo_thisRtn)( java_lang_StringBuffer
  This );
 jboolean (CFASTCALL *equals__Lo)( java_lang_Object This, java_lang_Object
  obj );
 jint (CFASTCALL *hashCode__)( java_lang_Object This );
 java_lang_String (CFASTCALL *toString__)( java_lang_StringBuffer This
  );
 void (CFASTCALL *finalize__)( java_lang_Object This );
};

struct java_lang_StringBuffer_class_s
{
 struct java_lang_Class_s jcgo_class;
};

JCGO_SEP_EXTERN CONST struct java_lang_StringBuffer_methods_s java_lang_StringBuffer_methods;
JCGO_SEP_EXTERN JCGO_NOTHR_CONST struct java_lang_StringBuffer_class_s
 java_lang_StringBuffer__class;

struct java_lang_StringBuffer_s
{
 CONST struct java_lang_StringBuffer_methods_s *JCGO_IMMFLD_CONST jcgo_methods;
 JCGO_MON_DEFN
 jcharArr value;
 jbyteArr bytes;
 jint count;
...
JCGO_SEP_EXTERN JCGO_NOTHR_CONST struct java_lang_String_s jcgo_string1_StrngBff;
