...
struct java_lang_OutOfMemoryError_methods_s
{
 ...
 JCGO_CLINIT_DEFN
 java_lang_OutOfMemoryError (CFASTCALL *jcgo_thisRtn)( java_lang_OutOfMemoryError
  This );
...
struct java_lang_OutOfMemoryError_class_s
{
 struct java_lang_Class_s jcgo_class;
};

JCGO_SEP_EXTERN CONST struct java_lang_OutOfMemoryError_methods_s
 java_lang_OutOfMemoryError_methods;
JCGO_SEP_EXTERN JCGO_NOTHR_CONST struct java_lang_OutOfMemoryError_class_s
 java_lang_OutOfMemoryError__class;

struct java_lang_OutOfMemoryError_s
{
 CONST struct java_lang_OutOfMemoryError_methods_s *JCGO_IMMFLD_CONST
  jcgo_methods;
 JCGO_MON_DEFN
...
JCGO_SEP_EXTERN CONST jcgo_arrtype27_Object jcgo_array2_OtOfMmEr;

JCGO_SEP_EXTERN JCGO_NOTHR_CONST struct java_lang_String_s jcgo_string1_OtOfMmEr;
